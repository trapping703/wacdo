...
insert into Restaurant(id, nom, codePostal, ville) values (1,'Wacdo laMax', 57000, 'Nice');
insert into Restaurant(id, nom, codePostal, ville) values (2,'Wacdo yana', 67000, 'Paris');
insert into Restaurant(id, nom, codePostal, ville) values (3,'Wacdo adipiscing', 77000, 'Lyon');
insert into Restaurant(id, nom, codePostal, ville) values (4,'Wacdo consectetur', 87000, 'Strasbourg');
insert into Restaurant(id, nom, codePostal, ville) values (5,'Wacdo amet', 97000, 'Montpelier');
